...
//=====[Recipe setting menu]=====//
if(!function_exists('amJL_event_meta')){
    function amJL_event_meta(){
        add_meta_box('event_structure', 'Event 設定項目', 'amJL_event_form', 'post', 'advanced' );
    }
}
if((int)get_option('event_check') === 1) add_action('admin_menu', 'amJL_event_meta');


//=====[Recipe from]=====//
if(!function_exists('amJL_event_form')){
  function amJL_event_form(){
    global $post;
